    ...
    const beers =[
      ...
      },
      {
        ...
        "description": "We let it sit out in the open air for 12 hours for perfect flatness and add brown sauce for more brownness.",
        "image_url": "https://images.punkapi.com/v2/5.png",
        "reviews": [
          "Tastes like a weird squid"
        ]
      },
      {
        "id": 4,
      ...
      },
      {
        ...
        "reviews": [
          "I lost my pet squirrel to this beer",
          "Where's the beef?!"
        ]
      },
      {
        ...
        "reviews": [
          "I like to drink this while watching TV",
          "A beer like no other, best served hot"
        ]
      },
      {
        "id": 7,
      ...
      },
      {
        ...
        "reviews": [
          "Woe is me, how I long for the days of yore",
          "Reminds me of that time I wasted all of my time",
          "It's a flavor that makes you wonder: 'Who is the boss: Angela or Tony?'"
        ]
      },
      {
        "id": 9,
      ...
      },
      {
        ...
        "reviews": [
          "Like autumn leaves readying themselves for the winter sun",
          "Beep beep, you're having a beer"
        ]
      }
    ]
